...
sys.path.append("../")
from utils.modeling import GAUConfig, GAUForMultipleChoice
...
from utils.roformer.modeling_roformer import RoFormerForMultipleChoice

WEIGHTS_NAME = "pytorch_model.bin"
MODEL_CLASSES = {
    # RoFormer, GAU
    'gau': (GAUConfig, GAUForMultipleChoice, BertTokenizerFast),
    'roformer': (RoFormerConfig, RoFormerForMultipleChoice, RoFormerTokenizer),
    'roformerv2': (RoFormerConfig, RoFormerForMultipleChoice, RoFormerTokenizer)
}
n_class = 4
reverse_order = False
sa_step = False
...
class c3Processor(DataProcessor):
    def __init__(self, data_dir):
        ...
        for sid in range(2):
            data = []
            for subtask in ["d", "m"]:
                with open(self.data_dir + "/" + subtask + "-" + ["train.json", "dev.json"][sid],
